        ...
        <div>
            <div className="row justify-content-center p-2" data-aos='fade-down'>
                  ...
                  <div className="col-md-6">
                       <h2 style={{fontSize:'40px'}}>Siparişlerim</h2>
                       ...
                       {cartItems.map(item=>{
                           ...
                           <div className='text-left m-1 w-100'>
                               ...
                               <h1>Fiyat : {item.quantity} * {item.prices[0][item.varient]} = {item.price}</h1>
                               <h1 style={{display:'inline'}}>Miktar : </h1>
                  ...
                  <div className="col-md-4 text-right">
                      <h2 style={{fontSize:'45px'}}>Toplam : {subtotal} TRY</h2>
